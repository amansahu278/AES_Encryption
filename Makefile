...
project:
	@$(COMPILER) -c src/progressBar/*.c -Iinclucde -o bin/progressBar.o
	@$(COMPILER) -c src/operations/*.c -Iinclude/ -o bin/operations.o
	...
	@$(COMPILER) bin/operations.o bin/encrypt.o bin/decrypt.o bin/keyOperations.o bin/progressBar.o bin/main.o -o AES